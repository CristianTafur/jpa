...
public class PagosController implements Serializable {
    ...
    private PagosJpaController jpaController = null;
    ...
    private PagosJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new PagosJpaController(utx, emf);
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getPagosCount();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getJpaController().findPagosEntities(getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getPagosCount();
        ...
        if (selectedItemIndex >= 0) {
            current = getJpaController().findPagosEntities(1, selectedItemIndex).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(getJpaController().findPagosEntities(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(getJpaController().findPagosEntities(), true);
    }
    ...
    public static class PagosControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getJpaController().findPagos(getKey(value));
        }
