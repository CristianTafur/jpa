...
public class UsuarioController implements Serializable {
    ...
    public String create() {
        try {
            if (!current.getDocumento().isEmpty()) {
                if (!current.getNombre().isEmpty()) {
                    if (!current.getRol().isEmpty()) {
                        if(getJpaController().findUsuario(current.getDocumento())==null){
                            current.setPass(current.getDocumento());
            ...
            JsfUtil.addErrorMessage(ResourceBundle.getBundle("/Bundle").getString("UsuarioNotCreated"));
            return prepareCreate();
        } catch (Exception e) {
    ...
    private void performDestroy() {
        try {
            getJpaController().destroy(current.getDocumento());
